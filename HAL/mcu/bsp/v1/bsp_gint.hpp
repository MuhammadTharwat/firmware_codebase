...
namespace bsp
{
	...
	public:
		...
		~gint_base(void) = default;
        virtual int16_t cfg(const tstr_group_interrupt_cfg &) = 0;
        virtual int16_t enable(void) const = 0;
        virtual int16_t disable(void) const = 0;
	};
	...
	public:
        ...
        int16_t cfg(const tstr_group_interrupt_cfg &) override;
        int16_t enable(void) const override;
        int16_t disable(void) const override;
	private:
		gint(void) = default;
