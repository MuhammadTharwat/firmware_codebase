...
namespace bsp
{
    ...
    using tpfun_adc_cplt = void (*)(int16_t );
    struct tstr_adc_conv_cfg
    {
        tenu_adc_res enu_res;         /*ADC Resolution*/
        const uint8_t *pu8_channels;      /*Channels*/
        uint8_t u8_num_channels;          /*Number of channels (1 in single channel mode)*/
        void *pv_adc_raw_buff;            /*Data Buffer
                                            ...
                                            last*/
        size_t sz_adc_raw_buff_max;       /*Buffer Size*/
        size_t sz_num_samples;            /*Number of samples*/
        uint32_t u32_sampling_rate;       /*Sampling Rate as SPS*/
    ...
    class adc_base
    {
        public :
            ...
            virtual uint32_t get_vref(void) const = 0;
            virtual int16_t start_conv(tstr_bsp_adc_conv_cfg &) = 0;
    ...
    class adc : private noncopyable, public adc_base
    {
        public :
            ...
            uint32_t get_vref(void) const override;
            int16_t start_conv(tstr_bsp_adc_conv_cfg &) override;
